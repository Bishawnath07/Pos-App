...
const OrderPage = () => {
    ...
    return (
        <div className="mx-5 relative">
            <div className="flex items-center justify-center -ml-[2rem] md:-ml-[5rem] gap-3 md:gap-5">
                <div className="dropdown relative">
                    <div tabIndex={0} role="button" className="btn btn-ghost btn-circle">
                        <HiMenu className="h-8 w-8 mb-[6px]" />
                    </div>
                    <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-[#e4e1e1] rounded-box md:w-[20rem] w-[21rem] h-[30rem] md:h-[45rem] relative">
                        ...
                        {/* Open the modal*/}
                        <dialog id="my_modal_4" className="modal md:modal-middle  md:w-1/2 sm:modal-top">
                            <div className="modal-box md:modal-cart">
                                <div className="">
                                    <div className="flex justify-items-start items-center gap-16 md:gap-40 mb-6">

                                        <form method="dialog">
                                            <button  ><HiChevronLeft className="h-6 w-6" /></button>
                                        </form>
                                ...
                                <div role="tablist" className="tabs tabs-lifted ">
                                    <input type="radio" name="my_tabs_2" role="tab" className="tab border border-[#c4c2c2] font-bold" aria-label="Tax On" />
                                    <div className=" bg-base-100 border-base-300 rounded-box p-6 ">

                                        <p className="flex tab-content items-center gap-5 mb-4"> <input type="radio" name="radio-3" className="radio radio-secondary" checked /><span>After Discount</span></p>
                                        <p className="flex tab-content items-center gap-5"> <input type="radio" name="radio-3" className="radio radio-secondary" id="" /><span>After Discount</span></p>



                                    </div>

                                    <input type="radio" name="my_tabs_2" role="tab" className="tab" aria-label="Tax Type" id="" />
                ...
                <ul className="flex gap-1 md:gap-5  md:my-3">
                    <li className="flex  justify-center items-center  gap-3 text-[#7b9bf3] hover:border-[#8eaaf7] cursor-pointer bg-[#d4defa] py-1 px-[7px] md:px-[4px] md:py-2 border-[1px] border-[#c9c5c5] rounded-sm  md:text-[16px] text-[11px] mb-2 md:font-bold  font-semibold"><FaEdit className="hidden md:block"> </FaEdit>Note</li>
                    <li className="flex  justify-center items-center  gap-3 text-[#7b9bf3] hover:border-[#8eaaf7] cursor-pointer bg-[#d4defa] py-1 px-[7px] md:px-[4px] md:py-2 border-[1px] border-[#c9c5c5] rounded-sm  md:text-[16px] text-[11px] mb-2 md:font-bold  font-semibold"><HiOutlineTruck className="hidden md:block"></HiOutlineTruck>Shipping</li>
                    <li className="flex  justify-center items-center  gap-3 text-[#7b9bf3] hover:border-[#8eaaf7] cursor-pointer bg-[#d4defa] py-1 px-[7px] md:px-[4px] md:py-2 border-[1px] border-[#c9c5c5] rounded-sm  md:text-[16px] text-[11px] mb-2 md:font-bold  font-semibold"><HiChartPie className="hidden md:block" />Hold Orders </li>
                    <li className="flex  justify-center items-center  gap-3 text-[#7b9bf3] hover:border-[#8eaaf7] cursor-pointer bg-[#d4defa] py-1 px-[7px] md:px-[4px] md:py-2 border-[1px] border-[#c9c5c5] rounded-sm  md:text-[16px] text-[11px] mb-2 md:font-bold  font-semibold"><HiDocumentAdd className="hidden md:block" />New Item</li>
            ...
            <div className="flex items-center justify-between px-5 py-3 bg-[#a3c8f8] ">
                ...
                <dialog id="my_modal_2" className="modal md:modal-middle  md:w-1/2 sm:modal-top">
                    <div className="modal-box md:modal-cart">
                        <div className="">
            ...
            <div className="flex items-center justify-between md:px-3 md:py-3 py-1 px-2 bg-[#a3c8f8] ">
                <div className="flex items-center gap-3">
                    <h1 className="font-semibold md:text-xl text-[16px] ">Products Counts({totalProductCount})</h1>
                </div>
                <h1 className="md:text-xl text-[16px] font-bold">Total {totalPrice} </h1>
            </div>
            <div className="my-3 flex gap-5 justify-between">
                ...
                <dialog id="my_modal_3" className="modal md:modal-middle sm:modal-top  md:w-1/2 ">
                    <div className="modal-box md:modal-cart  ">
                        <form method="dialog">
                        </form>
